 ...
 */
 ...
 export const defaultSubBlocks = JSON.stringify( [
     {
         title: __( 'Cool Timeline Pro Launched', 'timeline-block' ),
         description: __( 'Cool Timeline Pro is WordPress #1 premium timeline plugin, trusted by 20000+ users.', 'timeline-block' ),
         time: __( '14 July, 2016', 'timeline-block' ),
     ...
     {
         title: __( 'Add Story Title Here', 'timeline-block' ),
         description: __( 'Here you can add small description about your company history or achievements.', 'timeline-block' ),
         time: __( '01 June, 2019', 'timeline-block' ),
         key: new Date().getTime() + 1,
         storyImage:'none',
         storyBgColor:'#fff',
         storyTextColor:'#000',
 ...
 registerBlockType('cooltimeline/timeline-block', {
     ...
     category: 'layout',
     keywords: [
         __( 'timeline', 'timeline-block','instant timeline','events timeline' ),
     ],
     anchor: true,
     html: true,
     attributes: {
