		...
		<InspectorControls>
			...
			<PanelBody title={__("View Timeline Demos","timeline-block")} initialOpen={false}>
				<CardBody className="cp-timeline-block-demo-button">
					...
					<a target="_blank" className="button button-primary" href="https://cooltimeline.com/docs/timeline-block-pro/video-tutorials/free-plugin-video/?utm_source=tbg_plugin&utm_medium=inside&utm_campaign=demo&utm_content=timeline_block">Watch Videos</a>
				</CardBody>
			</PanelBody>
			{rating_box}
		</InspectorControls>
